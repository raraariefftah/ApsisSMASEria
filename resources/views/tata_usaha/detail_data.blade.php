                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="card">
                                    <div class="card-header" id="headingOne">
                                        ...
                                        <div class="card-tools">
                                            <a href="/detail_data/edit_keterangan_siswa" class="btn mr-2">
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingTwo">
                                        ...
                                        {{-- button edit --}}
                                        <div class="card-tools">
                                            <a href="/detail_data/edit_keterangan_ortu" class="btn mr-2">
                                                <i class="nav-icon fas fa-edit pr-1"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingThree">
                                        ...
                                        <div class="card-tools">
                                            <a href="/detail_data/edit_keterangan_wali" class="btn mr-2">
                                                <i class="nav-icon fas fa-edit pr-1"></i></a>
                                        </div>
                                    </div>
