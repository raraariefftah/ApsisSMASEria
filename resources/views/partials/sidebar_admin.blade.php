    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="/halaman_utama/home" class="nav-link" action="">
                        <i class="nav-icon fas fa-home"></i>
                        <p> Halaman Utama </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/admin/profil" class="nav-link" action="">
                ...
                {{-- 2 --}}
                <li class="nav-item">
                    <a href="/admin/dashboard" class="nav-link" action="">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/admin/edit_home" class="nav-link">
                                {{-- <i class="far fa-circle nav-icon"></i> --}}
                                <p style="color: black">Edit Home</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/admin/edit_profil" class="nav-link">
                                {{-- <i class="far fa-circle nav-icon"></i> --}}
                                <p style="color: black">Edit Profil</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/admin/edit_fasilitas" class="nav-link">
                                {{-- <i class="far fa-circle nav-icon"></i> --}}
                                <p style="color: black">Edit fasilitas</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/admin/edit_lulusPTN" class="nav-link">
                                {{-- <i class="far fa-circle nav-icon"></i> --}}
